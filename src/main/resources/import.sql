...
INSERT INTO device (mac_address, model, username, password, override_fragment) VALUES ('11-2b-3c-4d-5e-66', 'CONFERENCE', 'captain', 'blue', '{"domain":"starline.co.id","port":"5163","timeout":10}');
